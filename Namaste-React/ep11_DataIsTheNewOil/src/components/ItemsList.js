    ...
    return (
        <div className="px-5">
            {props.items.map((item) => (
                ...
                <div key={item.card.info.name} className="border-b border-gray-300 py-4">
                    <div className="flex justify-between">
                        ...
                        <div className="relative w-40 h-32 overflow-hidden rounded-lg">
                            <button className="absolute bottom-0 left-1/2 -translate-x-1/2 bg-white text-green-700 font-extrabold text-lg py-2 px-4 rounded-lg cursor-pointer shadow">
                                Add
                            </button>
                            <img
